...
// 密钥
const secret = "kehR3MRvMqPoQAA3oWdPbKKNuw0kmjtIC1aFhVzX6esfzIXCmoPQMzgCmF7KvcCPx9KWQH3khAjNXwJGex2x4FYMw17f2ZWXZEIq3tXtpNJHORnXUQkDjhAemOPhG5uH"

// 过期时间
const expires = time.Hour * 24

// CreateJWT 创建JWT
func CreateJWT(uid uint) string {
	nowTime := time.Now()
